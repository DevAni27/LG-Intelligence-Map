...
class TTSService{
  ...
  switch (category) {
    case EventCategory.earthquake:    return 'earthquake';
    case EventCategory.floodStorm:    return 'flood or storm';
    case EventCategory.wildfire:      return 'wildfire';
    case EventCategory.diseaseOutbreak: return 'disease outbreak';
    case EventCategory.conflict:      return 'conflict';
  }
}
}